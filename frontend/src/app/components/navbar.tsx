...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative h-full items-center rounded-2xl border border-transparent dark:bg-black dark:border-accent-dark bg-white shadow-input flex justify-between space-x-4 px-4 py-4"
    >
      {children}
    </nav>
  );
